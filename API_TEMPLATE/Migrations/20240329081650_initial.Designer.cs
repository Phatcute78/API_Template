...
namespace API_TEMPLATE.Migrations
{
    ...
    [Migration("20240329081650_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API_TEMPLATE.Models.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("API_TEMPLATE.Models.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("API_TEMPLATE.Models.Book", b =>
                {
                    b.HasOne("API_TEMPLATE.Models.Author", "Author")
                        .WithMany("Books")
